...
| Decomposer | `spooncraft_origins:bonemeal` | *Your body produces natural compost when you are damaged.* | The player spontaneously produces bonemeal at when damaged. | Fully Functional |
...
| Name | ID | Description (In-Game) | Description (Detailed) | Status |
|------------------|--------------------------------|-------------------------------------------------------------------------------------|----------------------------------------------------------------------------------------------------------|------------------|
| Little Companion | `rat:pickup` | *Other players can scoop you up!* | Other players can right click on the player to cause the player to be riding them. | Testing Required |
| Speedy | `spooncraft_origins:speedy` | *You can run around faster than usual.* | Player speed increased by 50% | Fully Functional |
| Acrobatics | `origins:fall_immunity` | *You never take fall damage, no matter from which height you fall.* | The player does not take any fall damage. | Fully Functional |
